...
function App() {
  ...
  const passwordGenerator = useCallback(()=>{
    ...
    if(numberAllowed) str+= "1237894506"
  ...
  return (
      ...
      <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 text-gray-800 bg-gray-600">
        ...
        <div className="flex shadow rounded-lg overflow-hidden mb-4">
          ...
          <button className='bg-blue-800 text-white p-3 ml-3 rounded-m' onClick = {copyPasswordToClipboard}>Copy</button>
        </div>
        <div className="flex text-sm gap-x-2">
          ...
          <div className="flex items-center gap-x-1">
            <input type="checkbox" defaultChecked={numberAllowed} id='numberInput' onChange={()=>{setCharacter((prev)=> !prev);}}/>
